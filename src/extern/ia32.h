...
#define CR4_PROTECTION_KEY_ENABLE(_)                                 (((_) >> 22) & 0x01)
    ...
    UINT64 ControlEnforcementTechnology : 1;
#define CR4_CONTROL_ENFORCEMENT_TECHNOLOGY_BIT                       23
#define CR4_CONTROL_ENFORCEMENT_TECHNOLOGY_FLAG                               0x800000
#define CR4_CONTROL_ENFORCEMENT_TECHNOLOGY_MASK                               0x01
#define CR4_CONTROL_ENFORCEMENT_TECHNOLOGY(_)                                 (((_) >> 23) & 0x01)
    UINT64 Reserved4                                               : 40;
  };
...
#define X86_XSTATE_AVX_MPX_AVX512_PKU_MASK (X86_XSTATE_AVX_MPX_MASK | X86_XSTATE_AVX512 | X86_XSTATE_PKRU)
